...
class SlidingToolbar extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _SlidingToolbarState();
}

class _SlidingToolbarState extends State<SlidingToolbar> {
  int? _isExpanded;
...
/// Organizes a list of widgets by expanding and collapsing and by using a
/// standard theme.
/// See also:
